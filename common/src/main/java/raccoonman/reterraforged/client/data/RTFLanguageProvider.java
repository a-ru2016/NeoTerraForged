...
public final class RTFLanguageProvider {
	...
	public static final class EnglishUS extends LanguageProvider {
		...
		protected void addTranslations() {
			...
			this.add(RTFTranslationKeys.GUI_SLIDER_LARGE_CAVERN_PROBABILITY, "Large Cavern Chance");
			this.add(RTFTranslationKeys.GUI_BUTTON_MASSIVE_CAVE_SURFACE_BREAKTHROUGH, "Massive Cave Surface Breakthrough");
			...
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_LARGE_CAVERN_PROBABILITY), "Controls the probability that a large underground cavern will generate. When > 0, the deep cave carver uses greatly enlarged radius multipliers (2.5-5x horizontal, 2-4x vertical) to create massive underground chambers.");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_BUTTON_MASSIVE_CAVE_SURFACE_BREAKTHROUGH), "When disabled, prevents massive caverns from breaking through to the surface by restricting their maximum height.");
